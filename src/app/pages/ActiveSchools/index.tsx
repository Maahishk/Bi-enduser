...
import { selectsubjectSlice, selectclassSlice } from './slice/selectors'
import { useActiveSchoolPageSlice } from 'app/pages/ActiveSchools/slice/index'
...
export const ActiveSchools = () => {
  ...
  const { actions } = useActiveSchoolPageSlice()
  const subjectdata = useSelector(selectsubjectSlice)
  const classdata = useSelector(selectclassSlice)
  ...
  useEffect(() => {
    if (subjectdata || classdata) {
      ...
      subjectdata.map((item: any) => {
        ...
        const activesubject = (
          <a href="/home/activeschool/activesubject" className={classes.link}>
            {subject}
          </a>
        )
  ...
  }, [subjectdata, classdata, classes.link])

  return (
    <>
      <Helmet>
        <title>Adhyayan School</title>
        <meta name="description" content="A Boilerplate application b2c page" />
      </Helmet>
      <Header title="Adhyayan School" desc="Schools >Adhyayan School" />
      <div className={classes.root}>
        ...
        <div className={classes.cardTable}>
          <CardTable
            title="Active Subjects in Adhyayan School (IVY SUBJECTS)"
        ...
        <div className={classes.cardTable}>
          <CardTable
            title="Active Classes in Adhyayan School (IVY SUBJECTS)"
